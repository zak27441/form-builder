...
const ContextMenu = ({ 
  ...
  // Detect if we should be in "Center/Modal" mode based on 0,0 position
  ...
  // Check field type for conditional rendering
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white rounded-lg overflow-visible"> 
        ...
        {/* NEW: Selected Question Display */}
        <div className="px-4 py-3 border-b border-gray-100 mb-2 bg-gray-50/50 rounded-t-lg">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Editing:</h3>
        ...
        {/* Conditionally render "Manage options" item for choice fields */}
        ...
        {/* Removed "Field Settings" header text and divider */}
        ...
        <MenuItem 
            ...
            onClick={() => {
                onDelete(); // Triggers FormCanvas handleDeleteField -> Opens New Modal
                onClose();
            }}
        />
      </div>
